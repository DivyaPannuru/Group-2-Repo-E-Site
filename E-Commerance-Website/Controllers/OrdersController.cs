...
namespace E_Commerance_Website.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            var myDbContext = _context.Orders.Include(o => o.Customer).Include(o => o.OrderStatus);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,OrderDate,CustomerId,OrderStatusId")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
